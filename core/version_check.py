...
def verCheck():
    ...
    ver_url = 'https://raw.githubusercontent.com/navin-hariharan/bomber/master/Core/version.txt'
    ...
    if ver_sc == 200:
        ...
        if ver_current == github_ver:
            ...
            sleep(2)
            system("git clone https://github.com/krishpranav/bomber ../TEMP")
            system("cd ..;rm -rf  bomber;mv TEMP bomber;cd bomber;chmod +x *")
